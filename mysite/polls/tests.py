...
class QuestionModelTests(TestCase):
    ...
    def test_was_publisched_recently_with_old_question(self):
        """
        was_published_recently returns False for questions whose pub_date
        is older than 1 day
        """
    ...
    def test_was_publisched_recently_with_recent_question(self):
        """
...
class QuestionIndexTextViewTests(TestCase):
...
class QuestionDetailViewTests(TestCase):
    ...
    def test_future_question(self):
        ...
        """
        question = create_question(question_text="Future question",
                                   days_offset=5)
    ...
    def test_past_question(self):
        ...
        """
        question = create_question('Past question', days_offset=(-5))
        url = reverse('polls:detail', args=(question.id,))
        response = self.client.get(url)
